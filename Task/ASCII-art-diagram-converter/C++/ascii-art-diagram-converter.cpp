...
// try some invalid tables
    ...
    static constexpr char invalidTable[] = "|";
    
    cout << "\n";
 //   Decode<missingFieldArt>(rawData);
 //   Decode<invalidTable>(rawData);

    // for testing with hardcoding raw data
    constexpr auto data = to_array<unsigned char>({0x78, 0x47, 0x7b, 0xbf, 0x54, 0x96, 0xe1, 0x2e, 0x1b, 0xf1, 0x69, 0xa4});
