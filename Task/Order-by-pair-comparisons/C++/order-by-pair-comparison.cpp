...
bool InteractiveCompare(const std::string& s1, const string& s2)
{
...
int main()
{
    ...
    // close to the minimum number of questions and has the nice property
    // for this task that it won't ask questions that the user could give 
    // conflicting answers to (e.g. red < green < blue < red)
    for(auto& item : items)
    {
